...
export function GameFilters({ filters, onFiltersChange, onReset }: GameFiltersProps) {
   ...
   return (
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
         {/* Header compacto */}
         <div className="dark:from-purple-900/20 dark:to-pink-900/20 px-3 sm:px-4 py-2.5 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between">
               <div className="flex items-center gap-2">
                  <Filter className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600 dark:text-purple-400" />
                  <h3 className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white">Filtros</h3>
                  {hasActiveFilters && (
                     <span className="px-2 py-0.5 bg-blue-500 text-white text-[10px] sm:text-xs font-bold rounded-full">
                        Activos
                     </span>
                  )}
               </div>
               {hasActiveFilters && (
                  <button
                     onClick={onReset}
                     className="flex items-center gap-1 px-2 sm:px-3 py-1 text-xs sm:text-sm font-medium text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors"
                  >
         ...
         <div className="p-3 sm:p-4 space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
               ...
               <div className="relative">
                  ...
                  <input
                     ...
                     className="w-full pl-9 pr-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                  />
               </div>

               {/* Type Tabs */}
               <div className="flex gap-1.5 sm:gap-2 bg-gray-100 dark:bg-gray-700 p-1 rounded-lg">
                  <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
               ...
               <select
                  ...
                  className="px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
               >
